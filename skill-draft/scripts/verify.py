...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="verify.py",
        description="skill-draft gate: fix and re-verify skill files using file-types.json.",
    )
...
def load_checkers() -> dict[str, Checker]:
    ...
    spec = importlib.util.spec_from_file_location("skill_draft_checkers", CHECKERS_PATH)
